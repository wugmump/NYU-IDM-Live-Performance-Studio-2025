...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 71.0, 31.0, 45.0, 22.0 ],
					"text" : "r world"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "list", "", "", "" ],
					"patching_rect" : [ 645.0, 529.0, 319.0, 37.0 ],
					"rows" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 4.0, 4.0 ],
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 377.0, 25.0, 245.0, 216.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 707.0, 222.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 707.0, 326.0, 119.0, 22.0 ],
					"text" : "jit.matrix background"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 707.0, 285.0, 99.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 71.0, 78.0, 195.0, 22.0 ],
...
, 			{
				...
				"patcherrelativepath" : "../../../../Max 9/Packages/cv.jit/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
