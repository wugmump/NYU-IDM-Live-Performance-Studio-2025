...
, 			{
		...
		"parameters" : 		{
			...
			"obj-3::obj-104" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-3::obj-15" : [ "pictctrl[2]", "pictctrl[1]", 0 ],
			"obj-3::obj-17" : [ "pictctrl[39]", "pictctrl[1]", 0 ],
			"obj-3::obj-21" : [ "Colorize[1]", "Colorize", 0 ],
			"obj-3::obj-23" : [ "pictctrl[1]", "pictctrl[1]", 0 ],
			"obj-3::obj-26" : [ "pictctrl[36]", "pictctrl[1]", 0 ],
			"obj-3::obj-278" : [ "textbutton[1]", "textbutton[1]", 0 ],
			"obj-3::obj-37" : [ "pictctrl[37]", "pictctrl[1]", 0 ],
			"obj-3::obj-46" : [ "pictctrl[8]", "pictctrl[1]", 0 ],
			...
			"obj-3::obj-59" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			"obj-3::obj-61" : [ "Zoom hi[1]", "Zoom", 1 ],
			"obj-3::obj-63" : [ "Zoom range[3]", "Zoom range", 1 ],
			"obj-3::obj-76" : [ "pictctrl[9]", "pictctrl[1]", 0 ],
			"obj-3::obj-78" : [ "Zoom lo[1]", "Zoom", 1 ],
			"obj-3::obj-8" : [ "pictctrl[3]", "pictctrl[1]", 0 ],
			"obj-3::obj-85" : [ "pictctrl[38]", "pictctrl[1]", 0 ],
			...
			"obj-3::obj-96" : [ "pictctrl[6]", "pictctrl[1]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
