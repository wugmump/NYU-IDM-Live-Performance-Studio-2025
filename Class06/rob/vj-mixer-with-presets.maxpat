...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 447.0, 328.0, 39.0, 22.0 ],
					"text" : "0 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.0, 328.0, 39.0, 22.0 ],
					"text" : "1 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 367.0, 361.0, 39.0, 22.0 ],
					"text" : "jit.line"
				}
...
, 			{
				"name" : "fx-chain-abs.maxpat",
				"bootpath" : "~/Documents/ITP/NYU-IDM-Live-Performance-Studio-2025/Class06/rob",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
